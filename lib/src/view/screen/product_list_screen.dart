...
import 'package:ecommerce/src/view/sub_category/CategoryScreen.dart';
          ...
          builder: (controller) {
            if(controller.categoryModel == null){
              ...
              return ListItemSelector(
                categoriesDataList: controller.categoryModel!.data!,
                onItemPressed: (index) {

                  Get.to(CategoryScreen(controller.categoryModel!.data![index]));
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                GetBuilder(builder: (ProductUrlController controller) {

                  if(controller.productModelHome == null){
                    return Center(child: CircularProgressIndicator());
                  }else{
                    return ProductGridView(
                      items: controller.productModelHome!.data!.data,
